use zingat::domain::clip::field::{Content, Expires, Password, ShortCode, Title};
use zingat::service::ask::{GetClip, NewClip, UpdateClip};
use zingat::web::api::{ApiKey, API_KEY_HEADER};
use zingat::Clip;
use std::error::Error;
use std::fmt::format;
...
#[derive(StructOpt, Debug)]
#[structopt(name = "clipclient", about = "Zingat API Client")]
struct Opt {
    #[structopt(subcommand)]
    command: Command,

    #[structopt(default_value = "http://127.0.0.1:8000", env = "ZINGAT_ADDR")]
    addr: String,
